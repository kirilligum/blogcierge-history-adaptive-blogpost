...
import { getApiKey } from '../../utils/apiKey'; // Corrected import path
...
export const POST: APIRoute = async ({request, locals}) => {
  ...
  if (!context) return new Response(JSON.stringify({error:'No messages found for selected devices'}),{status:404});
